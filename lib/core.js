//Fun fact: TBulter is initially known as fermions and pauli exclusion principle states that fermions cannot share the same quantum states 
...
TBulter = function() {
            ...
            template.created = function() {
                if (initSetting !== undefined) {
                    for(key in initSetting){
                        TBulter.env[key] = initSetting[key];
                    }
                }
                previousFn();
            }
    ...
    TBulter.lepton = function(arg1,arg2,arg3) {
    ...
    TBulter.quark = function(TemplateName, leptons, initSetting) {
        var TName,QName;
    ...
    TBulter.mobileView = function(mobile_max_width){
    ...
    TBulter.makeLogic = function(){
        return TBulter.lepton.apply(TBulter,arguments);
    }
    TBulter.bond = function(){
        return TBulter.quark.apply(TBulter,arguments);
    }
    TBulter.env = { /* this is where vars are shared among different TBulter*/ };
};
TBulter();
