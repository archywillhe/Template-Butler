...
Butler = function() {
    ...
    leptonPair.prototype.reset = function(forDevice) {
    ...
    virtualLepton.prototype.reset = function(forDevice){
        leptonsList[this.name].reset(forDevice);
        return this;
    }
    ...
    Butler.reset = function(leptonName,forDevice){
        return leptonsList[leptonName].reset(forDevice);
    }
